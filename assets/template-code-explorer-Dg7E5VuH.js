import{g as v,r as h,j as t,h as x}from"./index-CiLqJ9zT.js";import{j as F}from"./pdf-preview-CYdnKaK0.js";import{C as D}from"./code-block-DieJWZKp.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B=[["path",{d:"M12 19h8",key:"baeox8"}],["path",{d:"m4 17 6-6-6-6",key:"1yngyt"}]],ke=v("terminal",B),Ve={name:"modern",primitives:F,colors:{foreground:"#0f172a",background:"#ffffff",muted:"#f1f5f9",mutedForeground:"#64748b",primary:"#334155",primaryForeground:"#ffffff",border:"#e2e8f0",accent:"#6366f1",destructive:"#ef4444",success:"#22c55e",warning:"#f59e0b",info:"#3b82f6"},typography:{body:{fontFamily:"Helvetica",fontSize:11,lineHeight:1.6},heading:{fontFamily:"Helvetica",fontWeight:600,lineHeight:1.25,fontSize:{h1:28,h2:22,h3:18,h4:16,h5:14,h6:12}}},spacing:{page:{marginTop:40,marginRight:40,marginBottom:40,marginLeft:40},sectionGap:24,paragraphGap:10,componentGap:12},page:{size:"A4",orientation:"portrait"}},Be={name:"minimal",primitives:F,colors:{foreground:"#18181b",background:"#ffffff",muted:"#fafafa",mutedForeground:"#a1a1aa",primary:"#18181b",primaryForeground:"#ffffff",border:"#e4e4e7",accent:"#71717a",destructive:"#b91c1c",success:"#15803d",warning:"#a16207",info:"#0369a1"},typography:{body:{fontFamily:"Helvetica",fontSize:11,lineHeight:1.65},heading:{fontFamily:"Courier",fontWeight:600,lineHeight:1.25,fontSize:{h1:24,h2:20,h3:16,h4:14,h5:12,h6:10}}},spacing:{page:{marginTop:72,marginRight:56,marginBottom:72,marginLeft:56},sectionGap:36,paragraphGap:14,componentGap:18},page:{size:"A4",orientation:"portrait"}},W="https://pdfx.akashpise.dev/schema/registry-item.json",R="key-value",M="registry:ui",L="KeyValue",z="Label-value pair display with horizontal/vertical layout and dividers",E=[{path:"components/pdfx/key-value/pdfx-key-value.tsx",content:`import { Text as PDFText, StyleSheet, View } from '@react-pdf/renderer';
...
`,type:"registry:component"}],le=["@react-pdf/renderer"],ae=["theme"],Le={$schema:te,name:ne,type:oe,title:re,description:ie,files:se,dependencies:le,registryDependencies:ae},de="https://pdfx.akashpise.dev/schema/registry-item.json",ce="text",ye="registry:ui",pe="Text",ge="PDF text component for paragraphs",me=[{path:"components/pdfx/text/pdfx-text.tsx",content:`import { Text as PDFText, StyleSheet } from '@react-pdf/renderer';
import type { Style } from '@react-pdf/types';
import { usePdfxTheme, useSafeMemo } from '../lib/pdfx-theme-context';
type PdfxTheme = ReturnType<typeof usePdfxTheme>;
