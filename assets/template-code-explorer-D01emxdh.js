import{c as P,j as x}from"./index-I6Bgo7YV.js";import{j as o}from"./vendor-react-pdf-D5yotT0u.js";import{r as h}from"./vendor-router-CswRncel.js";import{C as V}from"./code-block-BwEgw_WR.js";/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const W=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],Re=P("chevron-right",W);/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],Me=P("eye",B);function F(){return typeof window<"u"}function R(){try{const e="production"}catch{}return"production"}function D(){return(F()?window.vam:R())||"production"}function C(){return D()==="production"}function M(){return D()==="development"}function L(e,{[e]:t,...r}){return r}function E(e,t){if(!e)return;let r=e;const n=[];for(const[s,i]of Object.entries(e))typeof i=="object"&&i!==null&&(t.strip?r=L(s,r):n.push(s));if(n.length>0&&!t.strip)throw Error(`The following properties are not valid: ${n.join(", ")}. Only strings, numbers, booleans, and null are allowed.`);return r}function Le(e,t,r){var n,s;if(!F()){const i="[Vercel Web Analytics] Please import `track` from `@vercel/analytics/server` when using this function in a server environment";if(C())console.warn(i);else throw new Error(i);return}if(!t){(n=window.va)==null||n.call(window,"event",{name:e,options:r});return}try{const i=E(t,{strip:C()});(s=window.va)==null||s.call(window,"event",{name:e,data:i,options:r})}catch(i){i instanceof Error&&M()&&console.error(i)}}const $="https://pdfx.akashpise.dev/schema/registry-item.json",z="key-value",j="registry:ui",O="KeyValue",H="Label-value pair display with horizontal/vertical layout and dividers",N=[{path:"components/pdfx/key-value/pdfx-key-value.tsx",content:`import { Text as PDFText, StyleSheet, View } from '@react-pdf/renderer';
...
`,type:"registry:component"}],pe=["@react-pdf/renderer"],ge=["theme"],je={$schema:se,name:le,type:ae,title:de,description:ce,files:ye,dependencies:pe,registryDependencies:ge},me="https://pdfx.akashpise.dev/schema/registry-item.json",ue="text",fe="registry:ui",he="Text",xe="PDF text component for paragraphs",Se=[{path:"components/pdfx/text/pdfx-text.tsx",content:`import { Text as PDFText, StyleSheet } from '@react-pdf/renderer';
import type { Style } from '@react-pdf/types';
import { usePdfxTheme, useSafeMemo } from '../lib/pdfx-theme-context';
import type React from 'react';
type PdfxTheme = ReturnType<typeof usePdfxTheme>;
...
`,type:"registry:component"}],be=["@react-pdf/renderer"],Te=["theme"],Oe={$schema:me,name:ue,type:fe,title:he,description:xe,files:Se,dependencies:be,registryDependencies:Te};function ve(e){return e.endsWith(".tsx")?"tsx":e.endsWith(".ts")?"ts":e.endsWith(".json")?"json":e.endsWith(".md")?"markdown":"tsx"}function S(e){const t=e.lastIndexOf("/");return t===-1?{folder:"",filename:e}:{folder:e.slice(0,t),filename:e.slice(t+1)}}function w(e,t){return{name:e,fullPath:t,children:new Map,files:[]}}function Ce(e){const t=w("","");for(const r of e){const{folder:n}=S(r.path);if(!n)t.files.push(r);else{const s=n.split("/");let i=t,a="";for(const d of s){a=a?`${a}/${d}`:d,i.children.has(d)||i.children.set(d,w(d,a));const g=i.children.get(d);g&&(i=g)}i.files.push(r)}}return t}function we(e){return e.sort((t,r)=>{const n=t.fullPath.startsWith("templates/"),s=r.fullPath.startsWith("templates/");return n&&!s?-1:!n&&s?1:t.name.localeCompare(r.name)})}function k({node:e,depth:t,activePath:r,onSelect:n,expandedPaths:s,onToggle:i}){const a=s.has(e.fullPath),d=we([...e.children.values()]),g=t*12+8;return o.jsxs(o.Fragment,{children:[e.name&&o.jsxs("button",{type:"button",onClick:()=>i(e.fullPath),className:"w-full flex items-center gap-1 pt-1.5 pb-0.5 hover:bg-accent/30 rounded transition-colors",style:{paddingLeft:g},children:[o.jsx(Pe,{expanded:a}),o.jsx(Fe,{}),o.jsxs("span",{className:"font-mono text-[11px] text-muted-foreground/80 truncate",title:e.fullPath,children:[e.name,"/"]})]}),(a||!e.name)&&e.files.map(c=>{const m=c.path===r,{filename:b}=S(c.path),T=e.name?g+16:g;return o.jsxs("button",{type:"button",onClick:()=>n(c.path),className:x("w-full text-left rounded-md font-mono text-[12px] leading-snug transition-colors flex items-center gap-1.5 py-1 pr-2",m?"bg-accent text-accent-foreground":"text-muted-foreground hover:text-foreground hover:bg-accent/50"),style:{paddingLeft:T},title:c.path,children:[o.jsx(De,{selected:m}),o.jsx("span",{className:"truncate",children:b})]},c.path)}),(a||!e.name)&&d.map(c=>o.jsx(k,{node:c,depth:e.name?t+1:t,activePath:r,onSelect:n,expandedPaths:s,onToggle:i},c.fullPath))]})}function He({files:e,className:t,initialPath:r}){var v;const n=h.useMemo(()=>[...e].sort((l,u)=>l.path.localeCompare(u.path)),[e]),s=r&&n.some(l=>l.path===r)?r:((v=n[0])==null?void 0:v.path)??"",[i,a]=h.useState(s),d=h.useMemo(()=>{const l=new Set;if(s){const{folder:u}=S(s);if(u){const y=u.split("/");let f="";for(const p of y)f=f?`${f}/${p}`:p,l.add(f)}}for(const u of n){const{folder:y}=S(u.path);if(y){const f=y.split("/")[0];if(f.startsWith("templates")){l.add(f);const p=y.split("/");p.length>=2&&(l.add(`${p[0]}/${p[1]}`),p.length>=3&&l.add(`${p[0]}/${p[1]}/${p[2]}`))}}}return l},[s,n]),[g,c]=h.useState(d),m=n.find(l=>l.path===i)??n[0],b=h.useMemo(()=>Ce(n),[n]),T=l=>{c(u=>{const y=new Set(u);return y.has(l)?y.delete(l):y.add(l),y})};return m?o.jsxs("div",{className:x("grid grid-cols-[260px_minmax(0,1fr)] rounded-xl border border-border overflow-hidden",t),children:[o.jsxs("div",{className:"border-r border-border bg-card/80 flex flex-col min-h-0",children:[o.jsx("div",{className:"px-3 py-2 border-b border-border text-[11px] font-medium uppercase tracking-wider text-muted-foreground shrink-0",children:"Files"}),o.jsx("div",{className:"overflow-auto flex-1 py-1.5",children:o.jsx(k,{node:b,depth:0,activePath:i,onSelect:a,expandedPaths:g,onToggle:T})})]}),o.jsx(V,{code:m.content,filename:m.path,language:m.language??ve(m.path),className:"rounded-none border-0 max-h-[70vh] overflow-auto"})]}):o.jsx("div",{className:x("rounded-xl border border-border bg-muted/30 p-4 text-sm text-muted-foreground",t),children:"No files available."})}function Pe({expanded:e}){return o.jsx("svg",{"aria-hidden":"true",width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:x("shrink-0 text-muted-foreground/50 transition-transform",e?"rotate-90":"rotate-0"),children:o.jsx("polyline",{points:"9 18 15 12 9 6"})})}function Fe(){return o.jsx("svg",{"aria-hidden":"true",width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",className:"shrink-0 text-muted-foreground/50",children:o.jsx("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})})}function De({selected:e}){return o.jsxs("svg",{"aria-hidden":"true",width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",className:x("shrink-0",e?"text-accent-foreground/70":"text-muted-foreground/40"),children:[o.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),o.jsx("polyline",{points:"14 2 14 8 20 8"})]})}export{Re as C,Me as E,He as T,ze as a,Oe as b,Ee as k,$e as p,je as s,Le as t};
