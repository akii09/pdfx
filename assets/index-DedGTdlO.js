import{j as e,S,D as w,P,V as a}from"./vendor-react-pdf-Cjwg34TF.js";import{p as $}from"./professional-1EdKjaJO.js";import{m as z,a as W}from"./minimal-ML8hqmHW.js";import{r as B,L as G}from"./vendor-router-_WzAYxGW.js";import{C as _,E as J,T as Q,k as Y,p as X,a as Z,s as ee,t as ne}from"./template-code-explorer-BoeDiDT6.js";import{C as E}from"./copy-button-BuD73-2k.js";import{c as te,o as oe,G as re,F as ie}from"./index-BVUCdc7j.js";import{b as j,u as D,P as ae}from"./pdf-preview-YKKRy4x0.js";import{u as le}from"./use-document-title-BkRAt5aO.js";import{T as o}from"./text-mjHqYYUG.js";import{S as b}from"./section-Bd7JsoDs.js";import{T as F,a as I,b as h,c as i,d as R}from"./table-B-3gYbvS.js";import{K as x}from"./key-value-BbBquBEe.js";import{P as V}from"./page-header-DgcuLkly.js";import{P as N}from"./page-footer-BD3OOa6g.js";import{P as K}from"./pdf-image-CuU5AWbP.js";import{T as q}from"./terminal-DXKPRYlv.js";import{C as se}from"./code-xml-tT7Ie-oj.js";import{L as O}from"./layers-CN9fTZrp.js";import{C as de}from"./check-FBLRPhcp.js";import"./code-block-B8bZ4oOe.js";import"./minus-pRI8vX-s.js";import"./external-link-DKMVq40k.js";import"./resolve-color-BxFvjghR.js";/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ce=[["path",{d:"M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719",key:"1sd12s"}]],me=te("message-circle",ce),pe=[{path:"templates/pdfx/invoice-classic/invoice-classic.tsx",content:`import { PdfxThemeProvider, usePdfxTheme } from '../../lib/pdfx-theme-context';
...
`,type:"registry:file"}],ve={files:Te},Ce=[{path:"templates/pdfx/invoice-modern/invoice-modern.tsx",content:`import { PdfxThemeProvider, usePdfxTheme } from '../../lib/pdfx-theme-context';
import { KeyValue } from '../../components/pdfx/key-value/pdfx-key-value';
import { PageFooter } from '../../components/pdfx/page-footer/pdfx-page-footer';
import { PageHeader } from '../../components/pdfx/page-header/pdfx-page-header';
import { Section } from '../../components/pdfx/section/pdfx-section';
...
`,type:"registry:file"}],Se={files:Ce},we="https://getpdfx.dev/schema/registry-item.json",Pe="pdf-image",je="registry:ui",De="Image",Fe="Image component with 7 display variants, fit modes, and optional captions",Ie=[{path:"components/pdfx/pdf-image/pdfx-pdf-image.tsx",content:`import { Image, Text as PDFText, StyleSheet, View } from '@react-pdf/renderer';
...
`,type:"registry:component"}],Re=["@react-pdf/renderer"],Ne=["theme"],ke={$schema:we,name:Pe,type:je,title:De,description:Fe,files:Ie,dependencies:Re,registryDependencies:Ne},Ve="https://getpdfx.dev/schema/registry-item.json",Be="table",Me="registry:ui",$e="Table",ze="Composable table with Table, TableRow, TableCell",We=JSON.parse("[{\"path\":\"components/pdfx/table/pdfx-table.tsx\",\"content\":\"import { Text as PDFText, View } from '@react-pdf/renderer';\\nimport type { Style } from '@react-pdf/types';\\nimport { Children, type ReactElement, type ReactNode, cloneElement, isValidElement } from 'react';\\nimport { usePdfxTheme, useSafeMemo } from '../lib/pdfx-theme-context';\\nimport { createTableStyles } from './pdfx-table.styles';\\nimport type {\\n  TableCellProps,\\n  TableProps,\\n  TableRowProps,\\n  TableSectionProps,\\n  TableVariant,\\n} from './pdfx-table.types';\\n\\nfunction processTableChildren(\\n  children: ReactNode,\\n  variant: TableVariant,\\n  zebraStripe: boolean\\n): ReactNode {\\n  let bodyRowIndex = 0;\\n\\n  return Children.map(children, (child) => {\\n    if (!isValidElement(child)) return child;\\n\\n    if (child.type === TableHeader || child.type === TableBody || child.type === TableFooter) {\\n      const isBody = child.type === TableBody;\\n      const sectionChild = child as ReactElement<TableSectionProps>;\\n      const sectionChildren = Children.map(sectionChild.props.children, (rowChild) => {\\n        if (isValidElement(rowChild) && rowChild.type === TableRow) {\\n          const rowProps: Partial<TableRowProps> = { variant };\\n\\n          if (isBody && zebraStripe) {\\n            const isStripe = bodyRowIndex % 2 === 1;\\n            bodyRowIndex++;\\n            if (isStripe) {\\n              rowProps.stripe = true;\\n            }\\n          }\\n\\n          return cloneElement(rowChild as ReactElement<TableRowProps>, rowProps);\\n        }\\n        return rowChild;\\n      });\\n\\n      return cloneElement(child, {}, sectionChildren);\\n    }\\n\\n    if (child.type === TableRow) {\\n      return cloneElement(child as ReactElement<TableRowProps>, { variant });\\n    }\\n\\n    return child;\\n  });\\n}\\n\\nexport function TableHeader({ children, style }: TableSectionProps) {\\n  return (\\n    <View minPresenceAhead={60} style={style}>\\n      {children}\\n    </View>\\n  );\\n}\\n\\nexport function TableBody({ children, style }: TableSectionProps) {\\n  return <View style={style}>{children}</View>;\\n}\\n\\nexport function TableFooter({ children, style }: TableSectionProps) {\\n  return <View style={style}>{children}</View>;\\n}\\n\\nexport function Table({\\n  children,\\n  style,\\n  variant = 'line',\\n  zebraStripe = false,\\n  noWrap = false,\\n}: TableProps) {\\n  const theme = usePdfxTheme();\\n  const styles = useSafeMemo(() => createTableStyles(theme), [theme]);\\n  const tableStyles: Style[] = [styles.table];\\n  const effectiveZebra = variant === 'striped' ? true : zebraStripe;\\n\\n  tableStyles.push(\\n    {\\n      grid: styles.tableGrid,\\n      line: styles.tableLine,\\n      minimal: styles.tableMinimal,\\n      striped: styles.tableStriped,\\n      compact: styles.tableCompact,\\n      bordered: styles.tableBordered,\\n      'primary-header': styles.tablePrimaryHeader,\\n    }[variant]\\n  );\\n\\n  const styleArray = style ? [...tableStyles, style] : tableStyles;\\n  const processedChildren = processTableChildren(children, variant, effectiveZebra);\\n\\n  const inner = <View style={styleArray}>{processedChildren}</View>;\\n  return noWrap ? <View wrap={false}>{inner}</View> : inner;\\n}\\n\\nexport function TableRow({\\n  header,\\n  footer,\\n  stripe,\\n  children,\\n  style,\\n  variant = 'line',\\n}: TableRowProps) {\\n  const theme = usePdfxTheme();\\n  const styles = useSafeMemo(() => createTableStyles(theme), [theme]);\\n  const rowStyles: Style[] = [styles.row];\\n\\n  rowStyles.push(\\n    {\\n      grid: styles.rowGrid,\\n      line: styles.rowLine,\\n      minimal: styles.rowMinimal,\\n      striped: styles.rowStriped,\\n      compact: styles.rowCompact,\\n      bordered: styles.rowBordered,\\n      'primary-header': styles.rowPrimaryHeader,\\n    }[variant]\\n  );\\n\\n  if (header) {\\n    rowStyles.push(\\n      {\\n        grid: styles.rowHeaderGrid,\\n        line: styles.rowHeaderLine,\\n        minimal: styles.rowHeaderMinimal,\\n        striped: styles.rowHeaderStriped,\\n        compact: styles.rowHeaderCompact,\\n        bordered: styles.rowHeaderBordered,\\n        'primary-header': styles.rowHeaderPrimaryHeader,\\n      }[variant]\\n    );\\n  }\\n\\n  if (footer) {\\n    if (variant === 'striped') rowStyles.push(styles.rowFooterStriped);\\n    else rowStyles.push(styles.rowFooter);\\n  }\\n\\n  if (stripe && !header && !footer) {\\n    rowStyles.push(styles.rowStripe);\\n  }\\n\\n  const styleArray = style ? [...rowStyles, style] : rowStyles;\\n  const childArray = Children.toArray(children);\\n  const processedChildren = childArray.map((child, i) => {\\n    if (isValidElement(child) && child.type === TableCell) {\\n      return cloneElement(child as ReactElement<TableCellProps>, {\\n        variant,\\n        header,\\n        footer,\\n        _last: i === childArray.length - 1,\\n      });\\n    }\\n    return child;\\n  });\\n\\n  return (\\n    <View wrap={false} style={styleArray}>\\n      {processedChildren}\\n    </View>\\n  );\\n}\\n\\nexport function TableCell({\\n  header,\\n  footer,\\n  align,\\n  width,\\n  children,\\n  style,\\n  variant = 'line',\\n  _last,\\n}: TableCellProps) {\\n  const theme = usePdfxTheme();\\n  const styles = useSafeMemo(() => createTableStyles(theme), [theme]);\\n  const cellStyles: Style[] =\\n    width !== undefined ? [styles.cellFixed, { width } as Style] : [styles.cell];\\n\\n  const cellVariantStyle = (\\n    {\\n      minimal: styles.cellMinimal,\\n      striped: styles.cellStriped,\\n      compact: styles.cellCompact,\\n      bordered: styles.cellBordered,\\n      'primary-header': styles.cellPrimaryHeader,\\n    } as Partial<Record<TableVariant, Style>>\\n  )[variant];\\n  if (cellVariantStyle) cellStyles.push(cellVariantStyle);\\n\\n  if (variant === 'grid' && !_last) {\\n    cellStyles.push(styles.cellGridBorder);\\n  } else if (variant === 'bordered' && !_last) {\\n    cellStyles.push(styles.cellBorderedBorder);\\n  }\\n\\n  if (align) {\\n    cellStyles.push({ textAlign: align } as Style);\\n  }\\n\\n  const styleArray = style ? [...cellStyles, style] : cellStyles;\\n\\n  let textStyle: Style = styles.cellText;\\n  if (header) {\\n    textStyle = {\\n      grid: styles.cellTextHeaderGrid,\\n      line: styles.cellTextHeaderLine,\\n      minimal: styles.cellTextHeaderMinimal,\\n      striped: styles.cellTextHeaderStriped,\\n      compact: styles.cellTextHeaderCompact,\\n      bordered: styles.cellTextHeaderBordered,\\n      'primary-header': styles.cellTextHeaderPrimaryHeader,\\n    }[variant];\\n  } else if (footer) {\\n    textStyle = styles.cellTextFooter;\\n  } else if (variant === 'compact') {\\n    textStyle = styles.cellTextCompact;\\n  }\\n\\n  const content =\\n    typeof children === 'string' ? (\\n      <PDFText style={[textStyle, align ? { textAlign: align } : {}, { margin: 0, padding: 0 }]}>\\n        {children}\\n      </PDFText>\\n    ) : (\\n      children\\n    );\\n\\n  return <View style={styleArray}>{content}</View>;\\n}\\n\",\"type\":\"registry:component\"},{\"path\":\"components/pdfx/table/pdfx-table.styles.ts\",\"content\":\"import { StyleSheet } from '@react-pdf/renderer';\\nimport { usePdfxTheme } from '../lib/pdfx-theme-context';\\ntype PdfxTheme = ReturnType<typeof usePdfxTheme>;\\n\\n/**\\n * Creates all table styles derived from the active theme.\\n * @param t - The resolved PdfxTheme instance.\\n */\\nexport function createTableStyles(t: PdfxTheme) {\\n  const { spacing, borderRadius, fontWeights, typography } = t.primitives;\\n  const borderColor = t.colors.border;\\n\\n  const hairline = 0.5;\\n  const rule = 1;\\n  const thick = 1.5;\\n\\n  const cellPadV = spacing[2] - 2;\\n  const cellPadH = spacing[2] + 2;\\n  const cellPadVCompact = spacing[0.5];\\n  const cellPadHCompact = spacing[2];\\n\\n  const rowDivider = {\\n    borderBottomWidth: hairline,\\n    borderBottomColor: borderColor,\\n    borderBottomStyle: 'solid' as const,\\n  };\\n\\n  return StyleSheet.create({\\n    table: {\\n      display: 'flex',\\n      flexDirection: 'column',\\n      width: '100%',\\n      marginBottom: t.spacing.componentGap,\\n    },\\n\\n    tableGrid: {\\n      borderWidth: thick,\\n      borderColor: borderColor,\\n      borderStyle: 'solid',\\n      borderTopLeftRadius: borderRadius.md,\\n      borderTopRightRadius: borderRadius.md,\\n      borderBottomLeftRadius: borderRadius.md,\\n      borderBottomRightRadius: borderRadius.md,\\n      overflow: 'hidden' as const,\\n    },\\n\\n    tableLine: {\\n      borderBottomWidth: hairline,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n\\n    tableMinimal: {\\n      paddingVertical: spacing[2],\\n    },\\n\\n    tableStriped: {\\n      borderTopWidth: hairline,\\n      borderTopColor: borderColor,\\n      borderTopStyle: 'solid',\\n      borderBottomWidth: hairline,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n\\n    tableCompact: {\\n      borderBottomWidth: hairline,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n\\n    tableBordered: {\\n      borderWidth: rule,\\n      borderColor: borderColor,\\n      borderStyle: 'solid',\\n      borderTopLeftRadius: borderRadius.sm,\\n      borderTopRightRadius: borderRadius.sm,\\n      borderBottomLeftRadius: borderRadius.sm,\\n      borderBottomRightRadius: borderRadius.sm,\\n      overflow: 'hidden' as const,\\n    },\\n\\n    tablePrimaryHeader: {\\n      borderBottomWidth: hairline,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n\\n    row: {\\n      flexDirection: 'row',\\n      display: 'flex',\\n    },\\n\\n    rowGrid: rowDivider,\\n    rowLine: rowDivider,\\n    rowMinimal: rowDivider,\\n    rowStriped: {},\\n    rowCompact: rowDivider,\\n    rowBordered: rowDivider,\\n    rowPrimaryHeader: rowDivider,\\n\\n    rowHeaderGrid: {\\n      backgroundColor: t.colors.muted,\\n      borderBottomWidth: rule,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n    rowHeaderLine: {\\n      borderBottomWidth: rule,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n    rowHeaderMinimal: {\\n      borderBottomWidth: rule,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n    rowHeaderStriped: {\\n      backgroundColor: t.colors.muted,\\n      borderBottomWidth: rule,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n    rowHeaderCompact: {\\n      backgroundColor: t.colors.muted,\\n      borderBottomWidth: rule,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n    rowHeaderBordered: {\\n      backgroundColor: t.colors.muted,\\n      borderBottomWidth: hairline,\\n      borderBottomColor: borderColor,\\n      borderBottomStyle: 'solid',\\n    },\\n    rowHeaderPrimaryHeader: {\\n      backgroundColor: t.colors.primary,\\n    },\\n\\n    rowFooter: {\\n      borderTopWidth: rule,\\n      borderTopColor: borderColor,\\n      borderTopStyle: 'solid',\\n    },\\n    rowFooterStriped: {\\n      borderTopWidth: rule,\\n      borderTopColor: borderColor,\\n      borderTopStyle: 'solid',\\n      backgroundColor: t.colors.muted,\\n    },\\n\\n    rowStripe: {\\n      backgroundColor: t.colors.muted,\\n    },\\n\\n    cell: {\\n      flex: 1,\\n      paddingVertical: cellPadV,\\n      paddingHorizontal: cellPadH,\\n      justifyContent: 'center',\\n    },\\n    cellFixed: {\\n      flexGrow: 0,\\n      flexShrink: 0,\\n      paddingVertical: cellPadV,\\n      paddingHorizontal: cellPadH,\\n      justifyContent: 'center',\\n    },\\n\\n    cellMinimal: {\\n      paddingVertical: spacing[1] + 1,\\n      paddingHorizontal: spacing[2] - 2,\\n    },\\n    cellStriped: {\\n      paddingVertical: cellPadV,\\n      paddingHorizontal: cellPadH,\\n    },\\n    cellCompact: {\\n      paddingVertical: cellPadVCompact,\\n      paddingHorizontal: cellPadHCompact,\\n    },\\n    cellBordered: {\\n      paddingVertical: cellPadV,\\n      paddingHorizontal: cellPadH,\\n    },\\n    cellPrimaryHeader: {\\n      paddingVertical: cellPadV,\\n      paddingHorizontal: cellPadH,\\n    },\\n\\n    cellGridBorder: {\\n      borderRightWidth: hairline,\\n      borderRightColor: borderColor,\\n      borderRightStyle: 'solid',\\n    },\\n    cellBorderedBorder: {\\n      borderRightWidth: hairline,\\n      borderRightColor: borderColor,\\n      borderRightStyle: 'solid',\\n    },\\n\\n    cellText: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: t.typography.body.fontSize,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n    },\\n\\n    cellTextHeaderGrid: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: t.typography.body.fontSize,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n      fontWeight: fontWeights.semibold,\\n    },\\n    cellTextHeaderLine: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: t.typography.body.fontSize,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n      fontWeight: fontWeights.semibold,\\n    },\\n    cellTextHeaderMinimal: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: t.typography.body.fontSize,\\n      lineHeight: 1.2,\\n      color: t.colors.mutedForeground,\\n      fontWeight: fontWeights.medium,\\n    },\\n    cellTextHeaderStriped: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: t.typography.body.fontSize,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n      fontWeight: fontWeights.semibold,\\n    },\\n    cellTextHeaderCompact: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: typography.xs,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n      fontWeight: fontWeights.semibold,\\n      textTransform: 'uppercase',\\n      letterSpacing: 0.6,\\n    },\\n    cellTextHeaderBordered: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: t.typography.body.fontSize,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n      fontWeight: fontWeights.bold,\\n    },\\n    cellTextHeaderPrimaryHeader: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: typography.xs,\\n      lineHeight: 1.2,\\n      color: t.colors.primaryForeground,\\n      fontWeight: fontWeights.semibold,\\n      textTransform: 'uppercase',\\n      letterSpacing: 0.6,\\n    },\\n\\n    cellTextFooter: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: t.typography.body.fontSize,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n      fontWeight: fontWeights.semibold,\\n    },\\n\\n    cellTextCompact: {\\n      fontFamily: t.typography.body.fontFamily,\\n      fontSize: typography.xs,\\n      lineHeight: 1.2,\\n      color: t.colors.foreground,\\n    },\\n  });\\n}\\n\",\"type\":\"registry:component\"},{\"path\":\"components/pdfx/table/pdfx-table.types.ts\",\"content\":\"import type { Style } from '@react-pdf/types';\\nimport type React from 'react';\\n\\n/** Table visual style variant. */\\nexport type TableVariant =\\n  | 'line'\\n  | 'grid'\\n  | 'minimal'\\n  | 'striped'\\n  | 'compact'\\n  | 'bordered'\\n  | 'primary-header';\\n\\n/**\\n * Table container with visual style variants and optional zebra striping.\\n * Props - `variant` | `zebraStripe` | `noWrap` | `children` | `style`\\n * @see {@link TableProps}\\n */\\nexport interface TableProps {\\n  /** Custom styles to merge with component defaults */\\n  style?: Style;\\n  /** Content to render */\\n  children: React.ReactNode;\\n  /**\\n   * @default 'line'\\n   */\\n  variant?: TableVariant;\\n  /**\\n   * @default false\\n   */\\n  zebraStripe?: boolean;\\n  /**\\n   * @default false\\n   */\\n  noWrap?: boolean;\\n}\\n\\nexport interface TableSectionProps {\\n  /** Custom styles to merge with component defaults */\\n  style?: Style;\\n  /** Content to render */\\n  children: React.ReactNode;\\n}\\n\\n/**\\n * Table row with optional header, footer, and stripe states.\\n * Props - `header` | `footer` | `stripe` | `variant` | `children` | `style`\\n * @see {@link TableRowProps}\\n */\\nexport interface TableRowProps {\\n  /** Custom styles to merge with component defaults */\\n  style?: Style;\\n  /** Content to render */\\n  children: React.ReactNode;\\n  header?: boolean;\\n  footer?: boolean;\\n  stripe?: boolean;\\n  variant?: TableVariant;\\n}\\n\\n/**\\n * Table cell with alignment, fixed width, and header or footer text styling.\\n * Props - `header` | `footer` | `align` | `width` | `variant` | `_last` | `children` | `style`\\n * @see {@link TableCellProps}\\n */\\nexport interface TableCellProps {\\n  /** Custom styles to merge with component defaults */\\n  style?: Style;\\n  /** Content to render */\\n  children: React.ReactNode;\\n  header?: boolean;\\n  footer?: boolean;\\n  align?: 'left' | 'center' | 'right';\\n  width?: string | number;\\n  variant?: TableVariant;\\n  _last?: boolean;\\n}\\n\",\"type\":\"registry:component\"}]"),He=["@react-pdf/renderer"],Le=["theme"],Ae={$schema:Ve,name:Be,type:Me,title:$e,description:ze,files:We,dependencies:He,registryDependencies:Le},Ge="https://github.com/akii09/pdfx",Ee="https://discord.gg/MuRtnU5B";function qe(){return e.jsxs("div",{className:"rounded-xl border border-border p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4",children:[e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Like what you see? ",e.jsx("span",{className:"font-medium text-foreground",children:"PDFX is open source."})]}),e.jsxs("div",{className:"flex items-center gap-2.5 shrink-0",children:[e.jsxs("a",{href:Ge,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-1.5 rounded-md border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-muted",children:[e.jsx(oe,{className:"h-3.5 w-3.5 fill-current text-yellow-500"}),"Star on GitHub",e.jsx(re,{className:"h-3.5 w-3.5 text-muted-foreground"})]}),e.jsxs("a",{href:Ee,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-1.5 rounded-md border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-muted",children:[e.jsx(me,{className:"h-3.5 w-3.5 text-[#5865F2]"}),"Join Discord"]})]})]})}const c={invoiceNumber:"INV-2026-001",dueDate:"March 17, 2026",companyName:"PDFx Inc.",subtitle:"Innovative PDF Solutions",companyAddress:"Nagpur, IN",billTo:{name:"Client Corp.",address:"456 Client Ave, Suite 2",email:"contact@clientcorp.com"},items:[{description:"Web Development",quantity:1,unitPrice:12500},{description:"UI/UX Design",quantity:1,unitPrice:8750},{description:"Consulting",quantity:10,unitPrice:1500}],summary:{subtotal:21250+10*1500,tax:.07*(21250+10*1500),total:21250+10*1500+.07*(21250+10*1500)},paymentTerms:{dueDate:"March 17, 2026",method:"UPI / Card / Bank Transfer",gst:"GSTIN 123456789"},notes:"Thank you for your business!"},Ke="/PDFX-LOGO.png";function Oe({theme:n}){return e.jsx(j,{theme:n,children:e.jsx(Ue,{})})}function Ue(){const n=D(),t=S.create({page:{padding:n.spacing.page.marginTop,paddingBottom:n.spacing.page.marginBottom,backgroundColor:n.colors.background}});return e.jsx(w,{title:"PDFx Invoice INV-001",children:e.jsxs(P,{size:"A4",style:t.page,children:[e.jsx(V,{variant:"logo-left",logo:e.jsx(K,{src:Ke,style:{margin:0}}),title:c.companyName,subtitle:c.subtitle,rightText:c.invoiceNumber,rightSubText:`Due: ${c.dueDate}`,style:{marginBottom:0}}),e.jsxs(b,{noWrap:!0,style:{flexDirection:"row"},children:[e.jsxs(a,{style:{flex:1,paddingRight:15},children:[e.jsx(o,{style:{fontSize:9,fontWeight:"bold",marginBottom:2},color:"mutedForeground",transform:"uppercase",noMargin:!0,children:"From"}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.companyName}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.companyAddress}),e.jsx(o,{noMargin:!0,variant:"xs",children:"hello@pdfx.io"})]}),e.jsxs(a,{style:{flex:1,paddingRight:15},children:[e.jsx(o,{style:{fontSize:9,fontWeight:"bold",marginBottom:2},color:"mutedForeground",transform:"uppercase",noMargin:!0,children:"Bill To"}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.billTo.name}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.billTo.address}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.billTo.email})]}),e.jsxs(a,{style:{flex:1,paddingRight:15},children:[e.jsx(o,{style:{fontSize:9,fontWeight:"bold",marginBottom:2},color:"mutedForeground",transform:"uppercase",noMargin:!0,children:"Payment Terms"}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.paymentTerms.method}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.paymentTerms.gst}),e.jsx(o,{noMargin:!0,variant:"xs",children:c.paymentTerms.dueDate})]})]}),e.jsxs(F,{variant:"grid",zebraStripe:!0,children:[e.jsx(I,{children:e.jsxs(h,{header:!0,children:[e.jsx(i,{children:"Description"}),e.jsx(i,{align:"center",children:"QTY"}),e.jsx(i,{align:"center",children:"Rate"}),e.jsx(i,{align:"right",children:"Total"})]})}),e.jsx(R,{children:c.items.map((r,l)=>e.jsxs(h,{children:[e.jsx(i,{children:r.description}),e.jsx(i,{align:"center",children:`${r.quantity}`}),e.jsx(i,{align:"center",children:`$${r.unitPrice}`}),e.jsx(i,{align:"right",children:`$${(r.quantity*r.unitPrice).toFixed(2)}`})]},l))})]}),e.jsx(b,{noWrap:!0,style:{flexDirection:"row",marginTop:16},children:e.jsx(a,{style:{marginLeft:"auto",width:220},children:e.jsx(x,{size:"sm",dividerThickness:1,items:[{key:"Subtotal",value:`$${c.summary.subtotal.toFixed(2)}`},{key:"Tax",value:`$${c.summary.tax.toFixed(2)}`},{key:"Total",value:`$${c.summary.total.toFixed(2)}`,valueStyle:{fontSize:12,fontWeight:"bold"},keyStyle:{fontSize:12,fontWeight:"bold",color:"primary"}}],divided:!0})})}),e.jsx(N,{leftText:c.notes,rightText:({pageNumber:r,totalPages:l})=>`Page ${r} of ${l}`,sticky:!0,pagePadding:25})]})})}const m={invoiceNumber:"INV-2026-002",invoiceDate:"February 18, 2026",dueDate:"March 20, 2026",companyName:"PDFx Inc.",subtitle:"Innovative PDF Solutions",companyAddress:"Nagpur, IN",billTo:{name:"TechStart Solutions",address:"789 Innovation Blvd, Floor 3",email:"billing@techstart.com",phone:"+1 (555) 987-6543"},items:[{description:"API Integration",quantity:1,unitPrice:15e3},{description:"SEO",quantity:2,unitPrice:5500},{description:"Security Audit",quantity:1,unitPrice:7200}],summary:{subtotal:15e3+2*5500+7200,tax:.07*(15e3+2*5500+7200),total:15e3+2*5500+7200+.07*(15e3+2*5500+7200)},paymentTerms:{method:"Wire Transfer / Bank Account",gst:"GSTIN 123456789"},notes:"Payment terms: Net 30 days. Thank you for your business!"};function _e({theme:n}){return e.jsx(j,{theme:n,children:e.jsx(Je,{})})}function Je(){const n=D(),t=S.create({page:{padding:n.spacing.page.marginTop,paddingBottom:n.spacing.page.marginBottom,backgroundColor:n.colors.background},metaRow:{flexDirection:"row",marginBottom:n.spacing.sectionGap},metaCol:{flex:1,paddingRight:12},metaLabel:{fontSize:8,fontWeight:"bold",color:n.colors.mutedForeground,textTransform:"uppercase",letterSpacing:.5,marginBottom:3},metaValue:{fontSize:9,color:n.colors.foreground},dividerCol:{width:1,backgroundColor:n.colors.border,marginRight:12}});return e.jsx(w,{title:"PDFx Invoice INV-002",children:e.jsxs(P,{size:"A4",style:t.page,children:[e.jsx(V,{variant:"branded",title:m.companyName,subtitle:`${m.subtitle}  ·  ${m.companyAddress}  ·  hello@pdfx.io`}),e.jsxs(a,{style:t.metaRow,children:[e.jsxs(a,{style:t.metaCol,children:[e.jsx(o,{style:t.metaLabel,noMargin:!0,children:"Invoice Number"}),e.jsx(o,{style:{...t.metaValue,fontWeight:"bold",fontSize:11},noMargin:!0,children:m.invoiceNumber})]}),e.jsxs(a,{style:t.metaCol,children:[e.jsx(o,{style:t.metaLabel,noMargin:!0,children:"Invoice Date"}),e.jsx(o,{style:t.metaValue,noMargin:!0,children:m.invoiceDate})]}),e.jsxs(a,{style:t.metaCol,children:[e.jsx(o,{style:t.metaLabel,noMargin:!0,children:"Due Date"}),e.jsx(o,{style:t.metaValue,noMargin:!0,children:m.dueDate})]}),e.jsx(a,{style:t.dividerCol}),e.jsxs(a,{style:{flex:2},children:[e.jsx(o,{style:t.metaLabel,noMargin:!0,children:"Billed To"}),e.jsx(o,{style:{...t.metaValue,fontWeight:"bold"},noMargin:!0,children:m.billTo.name}),e.jsx(o,{style:{...t.metaValue,color:n.colors.mutedForeground},noMargin:!0,children:m.billTo.address}),e.jsx(o,{style:{...t.metaValue,color:n.colors.mutedForeground},noMargin:!0,children:m.billTo.email}),e.jsx(o,{style:{...t.metaValue,color:n.colors.mutedForeground},noMargin:!0,children:m.billTo.phone})]})]}),e.jsxs(F,{variant:"primary-header",children:[e.jsx(I,{children:e.jsxs(h,{header:!0,children:[e.jsx(i,{children:"Description"}),e.jsx(i,{align:"center",children:"Qty"}),e.jsx(i,{align:"right",children:"Unit Price"}),e.jsx(i,{align:"right",children:"Amount"})]})}),e.jsx(R,{children:m.items.map((r,l)=>e.jsxs(h,{children:[e.jsx(i,{children:r.description}),e.jsx(i,{align:"center",children:`${r.quantity}`}),e.jsx(i,{align:"right",children:`$${r.unitPrice.toLocaleString()}`}),e.jsx(i,{align:"right",children:`$${(r.quantity*r.unitPrice).toFixed(2)}`})]},l))})]}),e.jsxs(b,{noWrap:!0,style:{flexDirection:"row",marginTop:16},children:[e.jsxs(a,{style:{flex:1,paddingRight:20},children:[e.jsx(o,{style:t.metaLabel,noMargin:!0,children:"Payment Method"}),e.jsx(o,{variant:"xs",noMargin:!0,children:m.paymentTerms.method}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:m.paymentTerms.gst})]}),e.jsx(a,{style:{width:220},children:e.jsx(x,{size:"sm",dividerThickness:1,items:[{key:"Subtotal",value:`$${m.summary.subtotal.toFixed(2)}`},{key:"Tax (7%)",value:`$${m.summary.tax.toFixed(2)}`},{key:"Total Due",value:`$${m.summary.total.toFixed(2)}`,valueStyle:{fontSize:12,fontWeight:"bold"},keyStyle:{fontSize:12,fontWeight:"bold"}}],divided:!0})})]}),e.jsx(N,{leftText:m.notes,rightText:({pageNumber:r,totalPages:l})=>`Page ${r} of ${l}`,sticky:!0,pagePadding:25})]})})}const u={invoiceNumber:"INV-2026-003",invoiceDate:"February 20, 2026",dueDate:"March 22, 2026",companyName:"PDFx Inc.",companyAddress:"Nagpur, IN",billTo:{name:"Enterprise Corp",address:"500 Enterprise Way, Building A",email:"finance@enterprisecorp.io",phone:"+1 (555) 246-8135"},items:[{description:"Annual License Plan",quantity:1,unitPrice:25e3},{description:"Support & Maintenance",quantity:12,unitPrice:1500},{description:"Custom Integration",quantity:1,unitPrice:12e3}],summary:{subtotal:25e3+12*1500+12e3,tax:.07*(25e3+12*1500+12e3),total:25e3+12*1500+12e3+.07*(25e3+12*1500+12e3)},paymentTerms:{method:"ACH Transfer / Check",gst:"GSTIN 123456789"},notes:"Invoice for annual enterprise subscription. Please retain for your records."};function Qe({theme:n}){return e.jsx(j,{theme:n,children:e.jsx(Ye,{})})}function Ye(){const n=D(),t=S.create({page:{padding:n.spacing.page.marginTop,paddingBottom:n.spacing.page.marginBottom,backgroundColor:n.colors.background},invoiceStamp:{borderWidth:2,borderColor:n.colors.primary,borderStyle:"solid",borderRadius:n.primitives.borderRadius.sm,paddingHorizontal:12,paddingVertical:8,alignSelf:"flex-start"},infoRow:{flexDirection:"row",marginBottom:n.spacing.sectionGap},infoLabel:{fontSize:8,fontWeight:"bold",color:n.colors.primary,textTransform:"uppercase",letterSpacing:.8,marginBottom:4}});return e.jsx(w,{title:"PDFx Invoice INV-003",children:e.jsxs(P,{size:"A4",style:t.page,children:[e.jsxs(b,{noWrap:!0,style:{flexDirection:"row",alignItems:"flex-start",marginBottom:n.spacing.sectionGap},children:[e.jsx(a,{style:{flex:1},children:e.jsx(V,{variant:"minimal",title:u.companyName,subtitle:`${u.companyAddress}  ·  hello@pdfx.io`,marginBottom:0})}),e.jsxs(a,{style:t.invoiceStamp,children:[e.jsx(o,{style:{fontSize:7,fontWeight:"bold",color:n.colors.primary,textAlign:"right"},noMargin:!0,transform:"uppercase",children:"Invoice"}),e.jsx(o,{style:{fontSize:14,fontWeight:"bold",color:n.colors.foreground,textAlign:"right"},noMargin:!0,children:u.invoiceNumber}),e.jsx(o,{style:{fontSize:8,color:n.colors.mutedForeground,textAlign:"right"},noMargin:!0,children:u.invoiceDate})]})]}),e.jsxs(a,{style:t.infoRow,children:[e.jsxs(a,{style:{flex:1,paddingRight:20},children:[e.jsx(o,{style:t.infoLabel,noMargin:!0,children:"Bill To"}),e.jsx(o,{variant:"sm",noMargin:!0,children:u.billTo.name}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:u.billTo.address}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:u.billTo.email}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:u.billTo.phone})]}),e.jsxs(a,{style:{flex:1},children:[e.jsx(o,{style:t.infoLabel,noMargin:!0,children:"Invoice Details"}),e.jsx(x,{size:"sm",items:[{key:"Due Date",value:u.dueDate},{key:"Payment",value:u.paymentTerms.method},{key:"GST",value:u.paymentTerms.gst}]})]})]}),e.jsxs(F,{variant:"compact",children:[e.jsx(I,{children:e.jsxs(h,{header:!0,children:[e.jsx(i,{children:"Description"}),e.jsx(i,{align:"center",children:"Qty"}),e.jsx(i,{align:"right",children:"Rate"}),e.jsx(i,{align:"right",children:"Total"})]})}),e.jsx(R,{children:u.items.map((r,l)=>e.jsxs(h,{children:[e.jsx(i,{children:r.description}),e.jsx(i,{align:"center",children:`${r.quantity}`}),e.jsx(i,{align:"right",children:`$${r.unitPrice.toLocaleString()}`}),e.jsx(i,{align:"right",children:`$${(r.quantity*r.unitPrice).toFixed(2)}`})]},l))})]}),e.jsxs(b,{noWrap:!0,style:{flexDirection:"row",marginTop:20},children:[e.jsx(a,{style:{flex:1}}),e.jsx(a,{style:{width:240},children:e.jsx(x,{size:"sm",dividerThickness:1,items:[{key:"Subtotal",value:`$${u.summary.subtotal.toFixed(2)}`},{key:"Tax (7%)",value:`$${u.summary.tax.toFixed(2)}`},{key:"Balance Due",value:`$${u.summary.total.toFixed(2)}`,valueStyle:{fontSize:13,fontWeight:"bold",color:n.colors.primary},keyStyle:{fontSize:12,fontWeight:"bold"}}],divided:!0})})]}),e.jsx(N,{leftText:u.notes,rightText:({pageNumber:r,totalPages:l})=>`Page ${r} of ${l}`,sticky:!0,pagePadding:25})]})})}const g={invoiceNumber:"INV-2026-004",invoiceDate:"February 22, 2026",dueDate:"March 24, 2026",companyName:"PDFx Inc.",subtitle:"Innovative PDF Solutions",companyAddress:"Nagpur, IN",billTo:{name:"Global Industries Ltd.",address:"100 Corporate Plaza, Tower B",email:"accounts@globalindustries.com",phone:"+1 (555) 888-9999"},items:[{description:"Enterprise Software License",quantity:5,unitPrice:4500},{description:"Implementation Services",quantity:1,unitPrice:18e3},{description:"Training Workshop (per session)",quantity:3,unitPrice:2500},{description:"Annual Support Package",quantity:1,unitPrice:8500}],summary:{subtotal:5*4500+18e3+3*2500+8500,tax:.08*(5*4500+18e3+3*2500+8500),total:(5*4500+18e3+3*2500+8500)*1.08},paymentTerms:{method:"Wire Transfer / Corporate Account"},notes:"Corporate billing – Net 30 terms apply. For inquiries, contact accounts@pdfx.io"},Xe="/PDFX-LOGO.png";function Ze({theme:n}){return e.jsx(j,{theme:n,children:e.jsx(en,{})})}function en(){const n=D(),t=S.create({page:{padding:n.spacing.page.marginTop,paddingBottom:n.spacing.page.marginBottom,backgroundColor:n.colors.background},infoGrid:{flexDirection:"row",marginBottom:n.spacing.sectionGap,gap:24},infoColumn:{flex:1},infoLabel:{fontSize:9,fontWeight:"bold",color:n.colors.mutedForeground,textTransform:"uppercase",letterSpacing:.6,marginBottom:6},summaryCard:{backgroundColor:n.colors.muted,borderRadius:n.primitives.borderRadius.md,padding:16,marginTop:20},summaryRow:{flexDirection:"row",justifyContent:"flex-end"}});return e.jsx(w,{title:"PDFx Invoice INV-004 – Corporate",children:e.jsxs(P,{size:"A4",style:t.page,children:[e.jsx(V,{variant:"logo-right",logo:e.jsx(K,{src:Xe,width:56,height:56,style:{margin:0}}),title:g.companyName,subtitle:`${g.subtitle}  ·  ${g.companyAddress}`,style:{marginBottom:n.spacing.sectionGap}}),e.jsxs(a,{style:t.infoGrid,children:[e.jsxs(a,{style:t.infoColumn,children:[e.jsx(o,{style:t.infoLabel,noMargin:!0,children:"Invoice Details"}),e.jsx(x,{size:"sm",items:[{key:"Invoice #",value:g.invoiceNumber},{key:"Issue Date",value:g.invoiceDate},{key:"Due Date",value:g.dueDate},{key:"Payment",value:g.paymentTerms.method}]})]}),e.jsxs(a,{style:t.infoColumn,children:[e.jsx(o,{style:t.infoLabel,noMargin:!0,children:"Bill To"}),e.jsx(o,{variant:"sm",weight:"semibold",noMargin:!0,children:g.billTo.name}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:g.billTo.address}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:g.billTo.email}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:g.billTo.phone})]})]}),e.jsxs(F,{variant:"bordered",children:[e.jsx(I,{children:e.jsxs(h,{header:!0,children:[e.jsx(i,{children:"Description"}),e.jsx(i,{align:"center",children:"Qty"}),e.jsx(i,{align:"right",children:"Unit Price"}),e.jsx(i,{align:"right",children:"Amount"})]})}),e.jsx(R,{children:g.items.map((r,l)=>e.jsxs(h,{children:[e.jsx(i,{children:r.description}),e.jsx(i,{align:"center",children:`${r.quantity}`}),e.jsx(i,{align:"right",children:`$${r.unitPrice.toLocaleString()}`}),e.jsx(i,{align:"right",children:`$${(r.quantity*r.unitPrice).toLocaleString()}`})]},l))})]}),e.jsx(a,{style:t.summaryCard,children:e.jsx(a,{style:t.summaryRow,children:e.jsx(a,{style:{width:260},children:e.jsx(x,{size:"md",dividerThickness:1,dividerColor:"border",items:[{key:"Subtotal",value:`$${g.summary.subtotal.toLocaleString()}`},{key:"Tax (8%)",value:`$${g.summary.tax.toFixed(2)}`},{key:"Total Due",value:`$${g.summary.total.toFixed(2)}`,valueStyle:{fontSize:14,fontWeight:"bold",color:n.colors.primary},keyStyle:{fontSize:13,fontWeight:"bold"}}],divided:!0})})})}),e.jsx(N,{leftText:g.notes,rightText:({pageNumber:r,totalPages:l})=>`Page ${r} of ${l}`,sticky:!0,pagePadding:25})]})})}const p={invoiceNumber:"INV-2026-005",invoiceDate:"February 24, 2026",dueDate:"March 26, 2026",companyName:"PDFx Inc.",subtitle:"Innovative PDF Solutions",companyAddress:"Nagpur, IN",billTo:{name:"Creative Agency Co.",address:"250 Design District, Loft 5",email:"studio@creativeagency.co",phone:"+1 (555) 321-7654"},items:[{description:"Brand Identity Design",quantity:1,unitPrice:8500},{description:"Marketing Collateral Package",quantity:1,unitPrice:4200},{description:"Social Media Assets (per set)",quantity:4,unitPrice:750},{description:"Motion Graphics (30s)",quantity:2,unitPrice:3500}],summary:{subtotal:12700+4*750+2*3500,tax:.065*(12700+4*750+2*3500),total:(12700+4*750+2*3500)*1.065},paymentTerms:{method:"Credit Card / PayPal / Stripe",gst:"GSTIN 456789123"},notes:"Creative work is protected under copyright. Full usage rights transfer upon payment."};function nn({theme:n}){return e.jsx(j,{theme:n,children:e.jsx(tn,{})})}function tn(){const n=D(),t=S.create({page:{padding:n.spacing.page.marginTop,paddingBottom:n.spacing.page.marginBottom,backgroundColor:n.colors.background},heroSection:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginBottom:n.spacing.sectionGap},invoiceBadge:{backgroundColor:n.colors.primary,borderRadius:n.primitives.borderRadius.md,paddingHorizontal:20,paddingVertical:14,alignItems:"center"},badgeLabel:{fontSize:8,fontWeight:"bold",color:n.colors.primaryForeground,textTransform:"uppercase",letterSpacing:1.2,marginBottom:2},badgeNumber:{fontSize:16,fontWeight:"bold",color:n.colors.primaryForeground},accentBlock:{backgroundColor:n.colors.muted,borderLeftWidth:4,borderLeftColor:n.colors.accent,borderLeftStyle:"solid",paddingLeft:14,paddingVertical:10,marginBottom:n.spacing.sectionGap},infoGrid:{flexDirection:"row",gap:32},infoColumn:{flex:1},sectionLabel:{fontSize:8,fontWeight:"bold",color:n.colors.accent,textTransform:"uppercase",letterSpacing:.8,marginBottom:6},summarySection:{flexDirection:"row",marginTop:24},summaryLeft:{flex:1,paddingRight:20},summaryRight:{width:240,backgroundColor:n.colors.muted,borderRadius:n.primitives.borderRadius.sm,padding:14}});return e.jsx(w,{title:"PDFx Invoice INV-005 – Creative",children:e.jsxs(P,{size:"A4",style:t.page,children:[e.jsxs(a,{style:t.heroSection,children:[e.jsx(a,{style:{flex:1},children:e.jsx(V,{variant:"centered",title:p.companyName,subtitle:`${p.subtitle}  ·  ${p.companyAddress}  ·  hello@pdfx.io`,marginBottom:0})}),e.jsxs(a,{style:t.invoiceBadge,children:[e.jsx(o,{style:t.badgeLabel,noMargin:!0,children:"Invoice"}),e.jsx(o,{style:t.badgeNumber,noMargin:!0,children:p.invoiceNumber})]})]}),e.jsx(a,{style:t.accentBlock,children:e.jsxs(a,{style:t.infoGrid,children:[e.jsxs(a,{style:t.infoColumn,children:[e.jsx(o,{style:t.sectionLabel,noMargin:!0,children:"Billed To"}),e.jsx(o,{variant:"sm",weight:"semibold",noMargin:!0,children:p.billTo.name}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:p.billTo.address}),e.jsxs(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:[p.billTo.email," · ",p.billTo.phone]})]}),e.jsxs(a,{style:t.infoColumn,children:[e.jsx(o,{style:t.sectionLabel,noMargin:!0,children:"Invoice Info"}),e.jsx(x,{size:"sm",items:[{key:"Issue Date",value:p.invoiceDate},{key:"Due Date",value:p.dueDate},{key:"Payment",value:p.paymentTerms.method}]})]})]})}),e.jsxs(F,{variant:"striped",zebraStripe:!0,children:[e.jsx(I,{children:e.jsxs(h,{header:!0,children:[e.jsx(i,{children:"Deliverable"}),e.jsx(i,{align:"center",children:"Qty"}),e.jsx(i,{align:"right",children:"Rate"}),e.jsx(i,{align:"right",children:"Amount"})]})}),e.jsx(R,{children:p.items.map((r,l)=>e.jsxs(h,{children:[e.jsx(i,{children:r.description}),e.jsx(i,{align:"center",children:`${r.quantity}`}),e.jsx(i,{align:"right",children:`$${r.unitPrice.toLocaleString()}`}),e.jsx(i,{align:"right",children:`$${(r.quantity*r.unitPrice).toLocaleString()}`})]},l))})]}),e.jsxs(b,{noWrap:!0,style:t.summarySection,children:[e.jsxs(a,{style:t.summaryLeft,children:[e.jsx(o,{style:t.sectionLabel,noMargin:!0,children:"Notes & Terms"}),e.jsx(o,{variant:"xs",color:"mutedForeground",children:p.notes}),e.jsxs(o,{variant:"xs",color:"mutedForeground",style:{marginTop:4},children:["GST: ",p.paymentTerms.gst]})]}),e.jsx(a,{style:t.summaryRight,children:e.jsx(x,{size:"sm",dividerThickness:1,items:[{key:"Subtotal",value:`$${p.summary.subtotal.toLocaleString()}`},{key:"Tax (6.5%)",value:`$${p.summary.tax.toFixed(2)}`},{key:"Total",value:`$${p.summary.total.toFixed(2)}`,valueStyle:{fontSize:14,fontWeight:"bold",color:n.colors.accent},keyStyle:{fontSize:13,fontWeight:"bold"}}],divided:!0})})]}),e.jsx(N,{variant:"centered",centerText:"Thank you for choosing PDFx Inc. for your creative needs!",sticky:!0,pagePadding:25})]})})}const s={invoiceNumber:"INV-2026-006",invoiceDate:"February 26, 2026",dueDate:"March 28, 2026",companyName:"PDFx Inc.",subtitle:"Professional Consulting Services",companyAddress:"Nagpur, IN · hello@pdfx.io",consultant:{name:"John Smith",title:"Senior Technical Consultant",email:"john.smith@pdfx.io"},client:{name:"Sarah Johnson",company:"Acme Technologies",address:"500 Tech Park, Suite 200",email:"sarah.johnson@acmetech.com"},services:[{description:"Architecture Review & Planning",hours:16,rate:175},{description:"Code Review & Optimization",hours:24,rate:150},{description:"Technical Documentation",hours:12,rate:125},{description:"Team Training & Knowledge Transfer",hours:8,rate:200}],summary:{totalHours:60,subtotal:9500,tax:.05*9500,total:1.05*9500},paymentTerms:{method:"Bank Transfer / Check"},projectRef:"PROJ-2026-ACME-001",notes:"Services rendered for February 2026. All hours verified and approved by client."};function on({theme:n}){return e.jsx(j,{theme:n,children:e.jsx(rn,{})})}function rn(){const n=D(),t=S.create({page:{padding:n.spacing.page.marginTop,paddingBottom:n.spacing.page.marginBottom,backgroundColor:n.colors.background},headerRow:{flexDirection:"row",justifyContent:"space-between",alignItems:"flex-start",marginBottom:n.spacing.sectionGap,paddingBottom:n.spacing.componentGap,borderBottomWidth:2,borderBottomColor:n.colors.primary,borderBottomStyle:"solid"},companyInfo:{flex:1},invoiceInfo:{alignItems:"flex-end"},partiesRow:{flexDirection:"row",gap:40,marginBottom:n.spacing.sectionGap},partyColumn:{flex:1},partyLabel:{fontSize:9,fontWeight:"bold",color:n.colors.primary,textTransform:"uppercase",letterSpacing:.6,marginBottom:6,paddingBottom:4,borderBottomWidth:1,borderBottomColor:n.colors.border,borderBottomStyle:"solid"},projectRef:{backgroundColor:n.colors.muted,paddingHorizontal:10,paddingVertical:6,borderRadius:n.primitives.borderRadius.sm,marginBottom:n.spacing.sectionGap,flexDirection:"row",alignItems:"center",gap:8},summaryRow:{flexDirection:"row",marginTop:20},hoursBox:{flex:1,paddingRight:24},hoursBadge:{backgroundColor:n.colors.primary,color:n.colors.primaryForeground,paddingHorizontal:12,paddingVertical:8,borderRadius:n.primitives.borderRadius.sm,alignSelf:"flex-start"},totalsBox:{width:250},calloutNote:{backgroundColor:n.colors.muted,borderLeftWidth:3,borderLeftColor:n.colors.info,borderLeftStyle:"solid",paddingLeft:12,paddingVertical:8,marginTop:16}});return e.jsx(w,{title:"PDFx Invoice INV-006 – Consultant",children:e.jsxs(P,{size:"A4",style:t.page,children:[e.jsxs(a,{style:t.headerRow,children:[e.jsxs(a,{style:t.companyInfo,children:[e.jsx(o,{variant:"xl",weight:"bold",noMargin:!0,children:s.companyName}),e.jsx(o,{variant:"sm",color:"mutedForeground",noMargin:!0,children:s.subtitle}),e.jsx(o,{variant:"xs",color:"mutedForeground",noMargin:!0,children:s.companyAddress})]}),e.jsxs(a,{style:t.invoiceInfo,children:[e.jsx(o,{variant:"xs",color:"mutedForeground",transform:"uppercase",noMargin:!0,children:"Invoice"}),e.jsx(o,{variant:"lg",weight:"bold",noMargin:!0,children:s.invoiceNumber}),e.jsx(o,{variant:"xs",color:"mutedForeground",noMargin:!0,children:s.invoiceDate}),e.jsxs(o,{variant:"xs",color:"mutedForeground",noMargin:!0,children:["Due: ",s.dueDate]})]})]}),e.jsxs(a,{style:t.projectRef,children:[e.jsx(o,{variant:"xs",weight:"semibold",color:"mutedForeground",noMargin:!0,children:"Project Reference:"}),e.jsx(o,{variant:"xs",weight:"bold",noMargin:!0,children:s.projectRef})]}),e.jsxs(a,{style:t.partiesRow,children:[e.jsxs(a,{style:t.partyColumn,children:[e.jsx(o,{style:t.partyLabel,noMargin:!0,children:"From (Consultant)"}),e.jsx(o,{variant:"sm",weight:"semibold",noMargin:!0,children:s.consultant.name}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:s.consultant.title}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:s.consultant.email})]}),e.jsxs(a,{style:t.partyColumn,children:[e.jsx(o,{style:t.partyLabel,noMargin:!0,children:"Bill To (Client)"}),e.jsx(o,{variant:"sm",weight:"semibold",noMargin:!0,children:s.client.name}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:s.client.company}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:s.client.address}),e.jsx(o,{variant:"xs",noMargin:!0,color:"mutedForeground",children:s.client.email})]})]}),e.jsxs(F,{variant:"line",children:[e.jsx(I,{children:e.jsxs(h,{header:!0,children:[e.jsx(i,{children:"Service Description"}),e.jsx(i,{align:"center",children:"Hours"}),e.jsx(i,{align:"right",children:"Rate ($/hr)"}),e.jsx(i,{align:"right",children:"Amount"})]})}),e.jsx(R,{children:s.services.map((r,l)=>e.jsxs(h,{children:[e.jsx(i,{children:r.description}),e.jsx(i,{align:"center",children:`${r.hours}`}),e.jsx(i,{align:"right",children:`$${r.rate}`}),e.jsx(i,{align:"right",children:`$${(r.hours*r.rate).toLocaleString()}`})]},l))})]}),e.jsxs(b,{noWrap:!0,style:t.summaryRow,children:[e.jsxs(a,{style:t.hoursBox,children:[e.jsx(a,{style:t.hoursBadge,children:e.jsxs(o,{style:{fontSize:9,fontWeight:"bold",color:n.colors.primaryForeground},noMargin:!0,children:["Total Hours: ",s.summary.totalHours]})}),e.jsxs(o,{variant:"xs",color:"mutedForeground",style:{marginTop:8},children:["Payment: ",s.paymentTerms.method]})]}),e.jsx(a,{style:t.totalsBox,children:e.jsx(x,{size:"sm",dividerThickness:1,items:[{key:"Subtotal",value:`$${s.summary.subtotal.toLocaleString()}`},{key:"Tax (5%)",value:`$${s.summary.tax.toFixed(2)}`},{key:"Amount Due",value:`$${s.summary.total.toFixed(2)}`,valueStyle:{fontSize:14,fontWeight:"bold",color:n.colors.primary},keyStyle:{fontSize:13,fontWeight:"bold"}}],divided:!0})})]}),e.jsx(a,{style:t.calloutNote,children:e.jsx(o,{variant:"xs",color:"mutedForeground",children:s.notes})}),e.jsx(N,{leftText:"Professional services invoice – Please retain for records",rightText:({pageNumber:r,totalPages:l})=>`Page ${r} of ${l}`,sticky:!0,pagePadding:25})]})})}const T=[Y,X,Z,ke,ee,Ae,ne].flatMap(n=>n.files.map(t=>({path:t.path,content:t.content})));function v(n,t){return n.map(r=>({path:r.path.replace(`templates/pdfx/${t}/`,""),content:r.content}))}function C(n,t){return[...n,...t]}const M=(()=>{const n=v(ue.files,"invoice-classic"),t=v(Se.files,"invoice-modern"),r=v(ve.files,"invoice-minimal"),l=v(xe.files,"invoice-corporate"),f=v(fe.files,"invoice-creative"),k=v(ye.files,"invoice-consultant");return[{id:"invoice-classic",label:"Classic",badge:"Professional",description:"Logo-left header with three-column billing info, zebra-striped grid table.",layout:"Logo Left · Grid Table",components:["PageHeader","Section","Table","KeyValue","PageFooter","Text","PdfImage"],codeFiles:n,explorerFiles:C(n,T),invoiceNumber:"INV-2026-001",Component:Oe,downloadFilename:"invoice-classic.pdf"},{id:"invoice-modern",label:"Modern",badge:"Branded",description:"Full-width branded banner, horizontal meta strip, primary-header table.",layout:"Branded Banner · Primary Header Table",components:["PageHeader","Section","Table","KeyValue","PageFooter","Text"],codeFiles:t,explorerFiles:C(t,T),invoiceNumber:"INV-2026-002",Component:_e,downloadFilename:"invoice-modern.pdf"},{id:"invoice-minimal",label:"Minimal",badge:"Clean",description:"Minimal underline header, inline invoice stamp, compact table layout.",layout:"Minimal · Compact Table",components:["PageHeader","Section","Table","KeyValue","PageFooter","Text"],codeFiles:r,explorerFiles:C(r,T),invoiceNumber:"INV-2026-003",Component:Qe,downloadFilename:"invoice-minimal.pdf"},{id:"invoice-corporate",label:"Corporate",badge:"Executive",description:"Logo-right header with two-column info layout, bordered table, muted summary card.",layout:"Logo Right · Bordered Table",components:["PageHeader","Section","Table","KeyValue","PageFooter","Text","PdfImage"],codeFiles:l,explorerFiles:C(l,T),invoiceNumber:"INV-2026-004",Component:Ze,downloadFilename:"invoice-corporate.pdf"},{id:"invoice-creative",label:"Creative",badge:"Bold",description:"Centered header with invoice badge, accent block billing, striped table.",layout:"Centered · Striped Table",components:["PageHeader","Section","Table","KeyValue","PageFooter","Text"],codeFiles:f,explorerFiles:C(f,T),invoiceNumber:"INV-2026-005",Component:nn,downloadFilename:"invoice-creative.pdf"},{id:"invoice-consultant",label:"Consultant",badge:"Hourly",description:"Two-column header, hourly billing with hours/rate columns, line table.",layout:"Two-Column · Line Table",components:["Section","Table","KeyValue","PageFooter","Text"],codeFiles:k,explorerFiles:C(k,T),invoiceNumber:"INV-2026-006",Component:on,downloadFilename:"invoice-consultant.pdf"}]})(),U={professional:{label:"Professional",description:"Serif headings, navy palette, generous margins",swatch:$.colors.primary,accent:$.colors.accent},modern:{label:"Modern",description:"Sans-serif, vibrant purple, tight spacing",swatch:W.colors.primary,accent:W.colors.accent},minimal:{label:"Minimal",description:"Monospace, stark black, maximum whitespace",swatch:z.colors.primary,accent:z.colors.accent}},an={professional:$,modern:W,minimal:z};function ln({template:n,active:t,onClick:r}){return e.jsxs("button",{type:"button",onClick:r,className:`relative text-left rounded-lg border p-3 transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${t?"border-primary bg-primary/5 shadow-sm":"border-border bg-card hover:border-primary/40 hover:shadow-sm"}`,children:[e.jsxs("div",{className:"flex items-center justify-between mb-1.5",children:[e.jsx("span",{className:`inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold tracking-wide uppercase ${t?"bg-primary text-primary-foreground":"bg-muted text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary"}`,children:n.badge}),e.jsx("span",{className:"text-[10px] font-mono text-muted-foreground/60",children:n.invoiceNumber})]}),e.jsx("h3",{className:`text-sm font-semibold mb-1 ${t?"text-primary":"text-foreground"}`,children:n.label}),e.jsx("p",{className:"text-xs text-muted-foreground leading-relaxed mb-2",children:n.description}),e.jsxs("div",{className:"flex items-center gap-1 text-[10px] text-muted-foreground/60 font-mono",children:[e.jsx(O,{className:"h-3 w-3 shrink-0"}),e.jsx("span",{className:"truncate",children:n.layout})]}),t&&e.jsx("div",{className:"absolute top-2.5 right-2.5 h-1.5 w-1.5 rounded-full bg-primary"})]})}function sn({preset:n,active:t,onClick:r}){const l=U[n];return e.jsxs("button",{type:"button",onClick:r,title:l.description,className:`group relative flex items-center gap-2 px-2.5 py-1.5 rounded-lg border text-left transition-all text-xs ${t?"border-primary bg-primary/5 font-medium":"border-border bg-card hover:border-primary/40 hover:bg-muted/50"}`,children:[e.jsx("span",{className:"shrink-0 h-3 w-3 rounded-full border border-black/10 shadow-sm",style:{backgroundColor:l.swatch}}),e.jsx("span",{className:t?"text-primary":"text-foreground",children:l.label}),t&&e.jsx(de,{className:"ml-auto h-3 w-3 text-primary"})]})}function dn(){var A;const[n,t]=B.useState("invoice-classic"),[r,l]=B.useState("professional"),[f,k]=B.useState("preview"),y=M.find(d=>d.id===n)??M[0],H=`npx pdfx-cli block add ${y.id}`,L=`npx shadcn@latest add @pdfx/${y.id}`;return le("Invoice Blocks"),e.jsxs("div",{className:"py-6",children:[e.jsxs("nav",{className:"flex items-center gap-1.5 text-xs text-muted-foreground mb-4",children:[e.jsx(G,{to:"/blocks",className:"hover:text-foreground transition-colors",children:"Blocks"}),e.jsx(_,{className:"h-3 w-3"}),e.jsx("span",{className:"text-foreground font-medium",children:"Invoices"})]}),e.jsxs("div",{className:"flex items-start justify-between gap-4 flex-wrap mb-4",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold tracking-tight text-foreground mb-1",children:"Invoice Blocks"}),e.jsxs("p",{className:"text-sm text-muted-foreground leading-relaxed",children:["Ready-to-use PDF invoice layouts built with"," ",e.jsx("code",{className:"text-xs bg-muted px-1.5 py-0.5 rounded font-mono",children:"@pdfx/components"}),"."]})]}),e.jsxs("div",{className:"shrink-0 flex flex-col gap-1.5",children:[e.jsxs("div",{className:"flex items-center gap-1.5 bg-muted/60 rounded-lg px-3 py-2 border border-border text-xs font-mono text-muted-foreground",children:[e.jsx(q,{className:"h-3.5 w-3.5 text-primary shrink-0"}),e.jsx("span",{children:H}),e.jsx(E,{value:H,className:"ml-1 text-muted-foreground hover:text-foreground hover:bg-muted rounded p-1 transition-colors"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 bg-muted/60 rounded-lg px-3 py-2 border border-border text-xs font-mono text-muted-foreground",children:[e.jsx(q,{className:"h-3.5 w-3.5 text-primary shrink-0"}),e.jsx("span",{children:L}),e.jsx(E,{value:L,className:"ml-1 text-muted-foreground hover:text-foreground hover:bg-muted rounded p-1 transition-colors"})]}),e.jsxs("p",{className:"text-[11px] text-muted-foreground text-right",children:["Register ",e.jsx("code",{className:"font-mono",children:"@pdfx"})," first."," ",e.jsx(G,{to:"/installation#shadcn",className:"underline hover:text-foreground",children:"shadcn setup"})]})]})]}),e.jsx("div",{className:"grid grid-cols-3 gap-2.5 mb-3",children:M.map(d=>e.jsx(ln,{template:d,active:n===d.id,onClick:()=>t(d.id)},d.id))}),e.jsxs("div",{className:"flex items-center justify-between gap-3 flex-wrap mb-3",children:[e.jsxs("div",{className:"flex items-center gap-1 bg-muted/60 rounded-lg p-0.5 border border-border",children:[e.jsxs("button",{type:"button",onClick:()=>k("preview"),className:`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${f==="preview"?"bg-background text-foreground shadow-sm border border-border":"text-muted-foreground hover:text-foreground"}`,children:[e.jsx(J,{className:"h-3.5 w-3.5"}),"Preview"]}),e.jsxs("button",{type:"button",onClick:()=>k("code"),className:`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${f==="code"?"bg-background text-foreground shadow-sm border border-border":"text-muted-foreground hover:text-foreground"}`,children:[e.jsx(se,{className:"h-3.5 w-3.5"}),"Code"]})]}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsx("span",{className:"text-[10px] font-medium text-muted-foreground uppercase tracking-wider mr-1",children:"Theme"}),Object.keys(U).map(d=>e.jsx(sn,{preset:d,active:r===d,onClick:()=>l(d)},d))]})]}),e.jsx("div",{className:"rounded-xl border border-border overflow-hidden shadow-sm mb-3",children:f==="preview"?e.jsx(ae,{title:`${y.label} — ${y.invoiceNumber}`,downloadFilename:y.downloadFilename,height:"h-[78vh]",children:e.jsx(y.Component,{theme:an[r]})}):e.jsx(Q,{files:y.explorerFiles,initialPath:(A=y.codeFiles[0])==null?void 0:A.path,className:"rounded-none border-0"})}),e.jsx(qe,{}),e.jsxs("div",{className:"flex flex-wrap gap-3 mt-3",children:[e.jsxs("div",{className:"rounded-lg border border-border bg-card px-4 py-3 flex-1 min-w-[200px]",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx(O,{className:"h-3.5 w-3.5 text-primary"}),e.jsx("span",{className:"text-xs font-semibold text-foreground",children:"Components"}),e.jsxs("span",{className:"ml-auto text-[10px] font-mono text-muted-foreground",children:[y.components.length," used"]})]}),e.jsx("div",{className:"flex flex-wrap gap-1.5",children:y.components.map(d=>e.jsx("code",{className:"text-[11px] font-mono bg-muted/60 text-muted-foreground rounded px-1.5 py-0.5",children:d},d))})]}),e.jsxs("div",{className:"rounded-lg border border-border bg-card px-4 py-3 flex-1 min-w-[200px]",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx(ie,{className:"h-3.5 w-3.5 text-primary"}),e.jsx("span",{className:"text-xs font-semibold text-foreground",children:"Block files"}),e.jsxs("span",{className:"ml-auto text-[10px] font-mono text-muted-foreground",children:[y.codeFiles.length," files"]})]}),e.jsx("div",{className:"flex flex-col gap-1",children:y.codeFiles.map(d=>e.jsx("span",{className:"text-[11px] font-mono text-muted-foreground bg-muted/50 rounded px-2 py-0.5 truncate",children:d.path},d.path))}),e.jsxs("p",{className:"text-[10px] text-muted-foreground/60 mt-2",children:["Installs to ",e.jsxs("code",{className:"font-mono",children:["./src/blocks/pdfx/",y.id,"/"]})]})]})]})]})}function Bn(){return e.jsx(dn,{})}export{Bn as default};
