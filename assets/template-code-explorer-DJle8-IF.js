import{c as w,j as x}from"./index-CceNQa7L.js";import{j as t}from"./vendor-react-pdf-Cjwg34TF.js";import{r as h}from"./vendor-router-_WzAYxGW.js";import{C as F}from"./code-block-Bs4ilJo3.js";/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],Pe=w("chevron-right",k);/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const D=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],Fe=w("eye",D),V="https://getpdfx.dev/schema/registry-item.json",W="key-value",B="registry:ui",R="KeyValue",M="Label-value pair display with horizontal/vertical layout and dividers",L=[{path:"components/pdfx/key-value/pdfx-key-value.tsx",content:`import { Text as PDFText, StyleSheet, View } from '@react-pdf/renderer';
...
`,type:"registry:component"}],ge=["@react-pdf/renderer"],me=["theme"],Be={$schema:le,name:ae,type:de,title:ce,description:ye,files:pe,dependencies:ge,registryDependencies:me};function ue(e){return e.endsWith(".tsx")?"tsx":e.endsWith(".ts")?"ts":e.endsWith(".json")?"json":e.endsWith(".md")?"markdown":"tsx"}function S(e){const n=e.lastIndexOf("/");return n===-1?{folder:"",filename:e}:{folder:e.slice(0,n),filename:e.slice(n+1)}}function C(e,n){return{name:e,fullPath:n,children:new Map,files:[]}}function fe(e){const n=C("","");for(const i of e){const{folder:o}=S(i.path);if(!o)n.files.push(i);else{const s=o.split("/");let l=n,a="";for(const d of s){a=a?`${a}/${d}`:d,l.children.has(d)||l.children.set(d,C(d,a));const g=l.children.get(d);g&&(l=g)}l.files.push(i)}}return n}function he(e){return e.sort((n,i)=>{const o=n.fullPath.startsWith("templates/"),s=i.fullPath.startsWith("templates/");return o&&!s?-1:!o&&s?1:n.name.localeCompare(i.name)})}function P({node:e,depth:n,activePath:i,onSelect:o,expandedPaths:s,onToggle:l}){const a=s.has(e.fullPath),d=he([...e.children.values()]),g=n*12+8;return t.jsxs(t.Fragment,{children:[e.name&&t.jsxs("button",{type:"button",onClick:()=>l(e.fullPath),className:"w-full flex items-center gap-1 pt-1.5 pb-0.5 hover:bg-accent/30 rounded transition-colors",style:{paddingLeft:g},children:[t.jsx(xe,{expanded:a}),t.jsx(Se,{}),t.jsxs("span",{className:"font-mono text-[11px] text-muted-foreground/80 truncate",title:e.fullPath,children:[e.name,"/"]})]}),(a||!e.name)&&e.files.map(c=>{const m=c.path===i,{filename:b}=S(c.path),T=e.name?g+16:g;return t.jsxs("button",{type:"button",onClick:()=>o(c.path),className:x("w-full text-left rounded-md font-mono text-[12px] leading-snug transition-colors flex items-center gap-1.5 py-1 pr-2",m?"bg-accent text-accent-foreground":"text-muted-foreground hover:text-foreground hover:bg-accent/50"),style:{paddingLeft:T},title:c.path,children:[t.jsx(be,{selected:m}),t.jsx("span",{className:"truncate",children:b})]},c.path)}),(a||!e.name)&&d.map(c=>t.jsx(P,{node:c,depth:e.name?n+1:n,activePath:i,onSelect:o,expandedPaths:s,onToggle:l},c.fullPath))]})}function Re({files:e,className:n,initialPath:i}){var v;const o=h.useMemo(()=>[...e].sort((r,u)=>r.path.localeCompare(u.path)),[e]),s=i&&o.some(r=>r.path===i)?i:((v=o[0])==null?void 0:v.path)??"",[l,a]=h.useState(s),d=h.useMemo(()=>{const r=new Set;if(s){const{folder:u}=S(s);if(u){const y=u.split("/");let f="";for(const p of y)f=f?`${f}/${p}`:p,r.add(f)}}for(const u of o){const{folder:y}=S(u.path);if(y){const f=y.split("/")[0];if(f.startsWith("templates")){r.add(f);const p=y.split("/");p.length>=2&&(r.add(`${p[0]}/${p[1]}`),p.length>=3&&r.add(`${p[0]}/${p[1]}/${p[2]}`))}}}return r},[s,o]),[g,c]=h.useState(d),m=o.find(r=>r.path===l)??o[0],b=h.useMemo(()=>fe(o),[o]),T=r=>{c(u=>{const y=new Set(u);return y.has(r)?y.delete(r):y.add(r),y})};return m?t.jsxs("div",{className:x("grid grid-cols-[260px_minmax(0,1fr)] rounded-xl border border-border overflow-hidden",n),children:[t.jsxs("div",{className:"border-r border-border bg-card/80 flex flex-col min-h-0",children:[t.jsx("div",{className:"px-3 py-2 border-b border-border text-[11px] font-medium uppercase tracking-wider text-muted-foreground shrink-0",children:"Files"}),t.jsx("div",{className:"overflow-auto flex-1 py-1.5",children:t.jsx(P,{node:b,depth:0,activePath:l,onSelect:a,expandedPaths:g,onToggle:T})})]}),t.jsx(F,{code:m.content,filename:m.path,language:m.language??ue(m.path),className:"rounded-none border-0 max-h-[70vh] overflow-auto"})]}):t.jsx("div",{className:x("rounded-xl border border-border bg-muted/30 p-4 text-sm text-muted-foreground",n),children:"No files available."})}function xe({expanded:e}){return t.jsx("svg",{"aria-hidden":"true",width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:x("shrink-0 text-muted-foreground/50 transition-transform",e?"rotate-90":"rotate-0"),children:t.jsx("polyline",{points:"9 18 15 12 9 6"})})}function Se(){return t.jsx("svg",{"aria-hidden":"true",width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",className:"shrink-0 text-muted-foreground/50",children:t.jsx("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})})}function be({selected:e}){return t.jsxs("svg",{"aria-hidden":"true",width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",className:x("shrink-0",e?"text-accent-foreground/70":"text-muted-foreground/40"),children:[t.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),t.jsx("polyline",{points:"14 2 14 8 20 8"})]})}export{Pe as C,Fe as E,Re as T,Ve as a,ke as k,De as p,We as s,Be as t};
