...
npx @akii09/pdfx-cli theme validate`,n=`// src/lib/pdfx-theme.ts — edit any token to restyle every component at once.
...
npx @akii09/pdfx-cli diff heading`,i="npm install @react-pdf/renderer",a=`{
...
npx @akii09/pdfx-cli add heading text table`,h=`import { PdfxThemeProvider } from '@pdfx/components';
