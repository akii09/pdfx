import{c as v,h as x}from"./index-MaI1d3bB.js";import{d as F}from"./pdf-preview-CLFj3N2n.js";import{j as o}from"./vendor-react-pdf-BZRS4xaB.js";import{r as h}from"./vendor-router-DN-v89qs.js";import{C as W}from"./code-block-B2HziCou.js";/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],Ee=v("chevron-right",B);/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],ze=v("eye",R);/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=[["path",{d:"M12 19h8",key:"baeox8"}],["path",{d:"m4 17 6-6-6-6",key:"1yngyt"}]],$e=v("terminal",M),je={name:"modern",primitives:F,colors:{foreground:"#0f172a",background:"#ffffff",muted:"#f1f5f9",mutedForeground:"#64748b",primary:"#334155",primaryForeground:"#ffffff",border:"#e2e8f0",accent:"#6366f1",destructive:"#ef4444",success:"#22c55e",warning:"#f59e0b",info:"#3b82f6"},typography:{body:{fontFamily:"Helvetica",fontSize:11,lineHeight:1.6},heading:{fontFamily:"Helvetica",fontWeight:600,lineHeight:1.25,fontSize:{h1:28,h2:22,h3:18,h4:16,h5:14,h6:12}}},spacing:{page:{marginTop:40,marginRight:40,marginBottom:40,marginLeft:40},sectionGap:24,paragraphGap:10,componentGap:12},page:{size:"A4",orientation:"portrait"}},He={name:"minimal",primitives:F,colors:{foreground:"#18181b",background:"#ffffff",muted:"#fafafa",mutedForeground:"#a1a1aa",primary:"#18181b",primaryForeground:"#ffffff",border:"#e4e4e7",accent:"#71717a",destructive:"#b91c1c",success:"#15803d",warning:"#a16207",info:"#0369a1"},typography:{body:{fontFamily:"Helvetica",fontSize:11,lineHeight:1.65},heading:{fontFamily:"Courier",fontWeight:600,lineHeight:1.25,fontSize:{h1:24,h2:20,h3:16,h4:14,h5:12,h6:10}}},spacing:{page:{marginTop:72,marginRight:56,marginBottom:72,marginLeft:56},sectionGap:36,paragraphGap:14,componentGap:18},page:{size:"A4",orientation:"portrait"}};function D(){return typeof window<"u"}function L(){try{const e="production"}catch{}return"production"}function k(){return(D()?window.vam:L())||"production"}function w(){return k()==="production"}function E(){return k()==="development"}function z(e,{[e]:t,...r}){return r}function $(e,t){if(!e)return;let r=e;const n=[];for(const[s,i]of Object.entries(e))typeof i=="object"&&i!==null&&(t.strip?r=z(s,r):n.push(s));if(n.length>0&&!t.strip)throw Error(`The following properties are not valid: ${n.join(", ")}. Only strings, numbers, booleans, and null are allowed.`);return r}function Oe(e,t,r){var n,s;if(!D()){const i="[Vercel Web Analytics] Please import `track` from `@vercel/analytics/server` when using this function in a server environment";if(w())console.warn(i);else throw new Error(i);return}if(!t){(n=window.va)==null||n.call(window,"event",{name:e,options:r});return}try{const i=$(t,{strip:w()});(s=window.va)==null||s.call(window,"event",{name:e,data:i,options:r})}catch(i){i instanceof Error&&E()&&console.error(i)}}const j="https://pdfx.akashpise.dev/schema/registry-item.json",H="key-value",O="registry:ui",N="KeyValue",_="Label-value pair display with horizontal/vertical layout and dividers",A=[{path:"components/pdfx/key-value/pdfx-key-value.tsx",content:`import { Text as PDFText, StyleSheet, View } from '@react-pdf/renderer';
...
`,type:"registry:component"}],ve=["@react-pdf/renderer"],Ce=["theme"],Ke={$schema:ue,name:he,type:xe,title:Se,description:be,files:Te,dependencies:ve,registryDependencies:Ce};function we(e){return e.endsWith(".tsx")?"tsx":e.endsWith(".ts")?"ts":e.endsWith(".json")?"json":e.endsWith(".md")?"markdown":"tsx"}function S(e){const t=e.lastIndexOf("/");return t===-1?{folder:"",filename:e}:{folder:e.slice(0,t),filename:e.slice(t+1)}}function P(e,t){return{name:e,fullPath:t,children:new Map,files:[]}}function Pe(e){const t=P("","");for(const r of e){const{folder:n}=S(r.path);if(!n)t.files.push(r);else{const s=n.split("/");let i=t,a="";for(const d of s){a=a?`${a}/${d}`:d,i.children.has(d)||i.children.set(d,P(d,a));const g=i.children.get(d);g&&(i=g)}i.files.push(r)}}return t}function Fe(e){return e.sort((t,r)=>{const n=t.fullPath.startsWith("templates/"),s=r.fullPath.startsWith("templates/");return n&&!s?-1:!n&&s?1:t.name.localeCompare(r.name)})}function V({node:e,depth:t,activePath:r,onSelect:n,expandedPaths:s,onToggle:i}){const a=s.has(e.fullPath),d=Fe([...e.children.values()]),g=t*12+8;return o.jsxs(o.Fragment,{children:[e.name&&o.jsxs("button",{type:"button",onClick:()=>i(e.fullPath),className:"w-full flex items-center gap-1 pt-1.5 pb-0.5 hover:bg-accent/30 rounded transition-colors",style:{paddingLeft:g},children:[o.jsx(De,{expanded:a}),o.jsx(ke,{}),o.jsxs("span",{className:"font-mono text-[11px] text-muted-foreground/80 truncate",title:e.fullPath,children:[e.name,"/"]})]}),(a||!e.name)&&e.files.map(c=>{const m=c.path===r,{filename:b}=S(c.path),T=e.name?g+16:g;return o.jsxs("button",{type:"button",onClick:()=>n(c.path),className:x("w-full text-left rounded-md font-mono text-[12px] leading-snug transition-colors flex items-center gap-1.5 py-1 pr-2",m?"bg-accent text-accent-foreground":"text-muted-foreground hover:text-foreground hover:bg-accent/50"),style:{paddingLeft:T},title:c.path,children:[o.jsx(Ve,{selected:m}),o.jsx("span",{className:"truncate",children:b})]},c.path)}),(a||!e.name)&&d.map(c=>o.jsx(V,{node:c,depth:e.name?t+1:t,activePath:r,onSelect:n,expandedPaths:s,onToggle:i},c.fullPath))]})}function Ye({files:e,className:t,initialPath:r}){var C;const n=h.useMemo(()=>[...e].sort((l,f)=>l.path.localeCompare(f.path)),[e]),s=r&&n.some(l=>l.path===r)?r:((C=n[0])==null?void 0:C.path)??"",[i,a]=h.useState(s),d=h.useMemo(()=>{const l=new Set;if(s){const{folder:f}=S(s);if(f){const y=f.split("/");let u="";for(const p of y)u=u?`${u}/${p}`:p,l.add(u)}}for(const f of n){const{folder:y}=S(f.path);if(y){const u=y.split("/")[0];if(u.startsWith("templates")){l.add(u);const p=y.split("/");p.length>=2&&(l.add(`${p[0]}/${p[1]}`),p.length>=3&&l.add(`${p[0]}/${p[1]}/${p[2]}`))}}}return l},[s,n]),[g,c]=h.useState(d),m=n.find(l=>l.path===i)??n[0],b=h.useMemo(()=>Pe(n),[n]),T=l=>{c(f=>{const y=new Set(f);return y.has(l)?y.delete(l):y.add(l),y})};return m?o.jsxs("div",{className:x("grid grid-cols-[260px_minmax(0,1fr)] rounded-xl border border-border overflow-hidden",t),children:[o.jsxs("div",{className:"border-r border-border bg-card/80 flex flex-col min-h-0",children:[o.jsx("div",{className:"px-3 py-2 border-b border-border text-[11px] font-medium uppercase tracking-wider text-muted-foreground shrink-0",children:"Files"}),o.jsx("div",{className:"overflow-auto flex-1 py-1.5",children:o.jsx(V,{node:b,depth:0,activePath:i,onSelect:a,expandedPaths:g,onToggle:T})})]}),o.jsx(W,{code:m.content,filename:m.path,language:m.language??we(m.path),className:"rounded-none border-0 max-h-[70vh] overflow-auto"})]}):o.jsx("div",{className:x("rounded-xl border border-border bg-muted/30 p-4 text-sm text-muted-foreground",t),children:"No files available."})}function De({expanded:e}){return o.jsx("svg",{"aria-hidden":"true",width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:x("shrink-0 text-muted-foreground/50 transition-transform",e?"rotate-90":"rotate-0"),children:o.jsx("polyline",{points:"9 18 15 12 9 6"})})}function ke(){return o.jsx("svg",{"aria-hidden":"true",width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",className:"shrink-0 text-muted-foreground/50",children:o.jsx("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})})}function Ve({selected:e}){return o.jsxs("svg",{"aria-hidden":"true",width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",className:x("shrink-0",e?"text-accent-foreground/70":"text-muted-foreground/40"),children:[o.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),o.jsx("polyline",{points:"14 2 14 8 20 8"})]})}export{Ee as C,ze as E,$e as T,je as a,Ye as b,Ae as c,Ke as d,Ne as k,He as m,_e as p,Ie as s,Oe as t};
