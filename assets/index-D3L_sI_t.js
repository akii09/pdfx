import{g as E,j as e,l as U,G as K,r as M,L as O,F as _}from"./index-DmNijxtX.js";import{f as w,u as C,S as P,D as j,a as D,V as a,p as $,P as J}from"./pdf-preview-DGXm3Lcf.js";import{C as Q,T as Y,E as X,m as W,a as z,b as Z,k as ee,p as ne,c as te,s as oe,t as re}from"./template-code-explorer-BadQq1eo.js";import{a as ie,b as ae}from"./code-block-BFJODRQs.js";import{u as le}from"./use-document-title-gI8AKaoa.js";import{T as o}from"./text-BPAvJUDy.js";import{S as b}from"./section-DgJiSZoC.js";import{T as F,a as R,b as y,c as i,d as I}from"./table-Deub-dkj.js";import{K as x}from"./key-value-CgbOFW0T.js";import{P as k}from"./page-header-DlojMNhG.js";import{P as B}from"./page-footer-C6tNYwl0.js";import{P as A}from"./pdf-image-p5Jt9G0W.js";import{C as se}from"./code-xml-DjumAeT8.js";import{L as G}from"./layers-DaVIqORQ.js";import"./resolve-color-BxFvjghR.js";/**
 * @license lucide-react v0.564.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=[["path",{d:"M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719",key:"1sd12s"}]],ce=E("message-circle",de),me=[{path:"templates/pdfx/invoice-classic/invoice-classic.tsx",type:"registry:template",content:`import type { PdfxTheme } from '../../lib/pdfx-theme';
  ...
  return (
    <Document title={\`Invoice \${data.invoiceNumber}\`}>
      <Page size="A4" style={styles.page}>
        <PageHeader
          variant="logo-right"
          logo={<PdfImage src={data.logo ?? '/favicon.png'} width={56} height={56} style={{ margin: 0 }} />}
          title={data.companyName}
...
`},{path:"templates/pdfx/invoice-corporate/invoice-corporate.types.ts",type:"registry:template",content:`export interface InvoiceCorporateData {
  invoiceNumber: string;
  invoiceDate: string;
  dueDate: string;
  companyName: string;
...
`}],ye={files:he},xe=[{path:"templates/pdfx/invoice-creative/invoice-creative.tsx",type:"registry:template",content:`import type { PdfxTheme } from '../../lib/pdfx-theme';
import { PdfxThemeProvider, usePdfxTheme } from '../../lib/pdfx-theme-context';
import { PageHeader } from '../../components/pdfx/page-header/pdfx-page-header';
import { PageFooter } from '../../components/pdfx/page-footer/pdfx-page-footer';
import { Table, TableBody, TableCell, TableHeader, TableRow } from '../../components/pdfx/table/pdfx-table';
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.heroSection}>
          ...
          <View style={styles.invoiceBadge}>
            <Text style={styles.badgeLabel} noMargin>Invoice</Text>
            <Text style={styles.badgeNumber} noMargin>{data.invoiceNumber}</Text>
          </View>
        </View>
...
`},{path:"templates/pdfx/invoice-creative/invoice-creative.types.ts",type:"registry:template",content:`export interface InvoiceCreativeData {
  invoiceNumber: string;
  invoiceDate: string;
  dueDate: string;
  companyName: string;
...
`}],be={files:xe},fe=[{path:"templates/pdfx/invoice-minimal/invoice-minimal.tsx",type:"registry:template",content:`import type { PdfxTheme } from '../../lib/pdfx-theme';
import { PdfxThemeProvider, usePdfxTheme } from '../../lib/pdfx-theme-context';
import { PageHeader } from '../../components/pdfx/page-header/pdfx-page-header';
import { PageFooter } from '../../components/pdfx/page-footer/pdfx-page-footer';
import { Table, TableBody, TableCell, TableHeader, TableRow } from '../../components/pdfx/table/pdfx-table';
...
`}],Te={files:fe},ve=[{path:"templates/pdfx/invoice-modern/invoice-modern.tsx",type:"registry:template",content:`import type { PdfxTheme } from '../../lib/pdfx-theme';
import { PdfxThemeProvider, usePdfxTheme } from '../../lib/pdfx-theme-context';
import { PageHeader } from '../../components/pdfx/page-header/pdfx-page-header';
import { PageFooter } from '../../components/pdfx/page-footer/pdfx-page-footer';
import { Table, TableBody, TableCell, TableHeader, TableRow } from '../../components/pdfx/table/pdfx-table';
...
`}],Se={files:ve},we="https://pdfx.akashpise.dev/schema/registry-item.json",Ce="pdf-image",Pe="registry:ui",je="PdfImage",De="Image component with 7 display variants, fit modes, and optional captions",Fe=[{path:"components/pdfx/pdf-image/pdfx-pdf-image.tsx",content:`import { Image, Text as PDFText, StyleSheet, View } from '@react-pdf/renderer';
