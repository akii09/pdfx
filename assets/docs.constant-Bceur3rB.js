const e=[{id:"installation",title:"Installation",level:2},{id:"shadcn",title:"shadcn CLI",level:2},{id:"usage",title:"Usage",level:2},{id:"cli-commands",title:"CLI Commands",level:2},{id:"theming",title:"Theming",level:2},{id:"theme-cli",title:"Theme CLI",level:3},{id:"customizing",title:"Customizing",level:3},{id:"runtime-theming",title:"Runtime Switching",level:3},{id:"how-it-works",title:"How It Works",level:2}],t=`# Initialize or replace your theme
...
npx pdfx-cli theme validate`,n=`// src/lib/pdfx-theme.ts — edit any token to restyle every component at once.
...
};`,o=`import { Document, Page } from '@react-pdf/renderer';
...
}`,r=`# Initialize PDFx in your project (includes theme setup)
npx pdfx-cli init
...
npx shadcn@latest list @pdfx`,i="npm install @react-pdf/renderer",a=`{
...
}`,s=`// This file was generated by pdfx init. You own it — customize freely.
// Docs: https://getpdfx.dev/installation#theming
//
...
// PdfxTheme type is inlined and exported here — no @pdfx/shared dependency needed.
...
};`,d=`// This file was generated by pdfx init. You own it — customize freely.
// Docs: https://getpdfx.dev/installation#theming
//
...
export function useSafeMemo<T>(factory: () => T, deps: DependencyList): T {
  ...
  pdfx.json                      # Project config (Step 2)`,l=`# Now you can copy components from each component's Manual tab.
# Or use the CLI to add them:
npx pdfx-cli add heading text table`,h=`import { PdfxThemeProvider } from '@pdfx/components';
...
</Document>`;export{a,s as b,d as c,m as d,l as e,t as f,n as g,h,r as i,i as m,e as t,o as u};
