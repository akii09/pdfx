...
function createStyles(t: PdfxTheme) {
  ...
  return StyleSheet.create({
    ...
    badge: {
      ...
      borderWidth: primitives.spacing[0.5],
      borderStyle: 'solid',
    ...
    badgeSuccess: { borderColor: t.colors.success, backgroundColor: muted },
    badgeSuccessText: { color: t.colors.success },
    badgeWarning: { borderColor: t.colors.warning, backgroundColor: muted },
    badgeWarningText: { color: t.colors.warning },
    badgeDestructive: { borderColor: t.colors.destructive, backgroundColor: muted },
    badgeDestructiveText: { color: t.colors.destructive },
    badgeInfo: { borderColor: t.colors.info, backgroundColor: muted },
