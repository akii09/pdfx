 ...
 *
 * The output inlines and exports the PdfxTheme type so consuming projects do not
 * need @pdfx/shared, and installed blocks can `import type { PdfxTheme }`.
 */
export function generateThemeFile(preset: PdfxTheme): string {
  return `// Generated by pdfx init.
// See: https://getpdfx.dev/installation#theming
//
